 ...
 */
void Trans_Ond(ac_int<8, false> Src[HEIGHT_IMAGE*WIDTH_IMAGE], ac_int<8, false> Dst[HEIGHT_IMAGE*WIDTH_IMAGE], int hi, int wi) {
 ...
 */
void image_copy(ac_int<8, false> Src[HEIGHT_IMAGE*WIDTH_IMAGE], ac_int<8, false> Dst[HEIGHT_IMAGE*WIDTH_IMAGE], int hi, int wi) {
