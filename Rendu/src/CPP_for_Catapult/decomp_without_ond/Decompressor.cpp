...
Decompressor::Decompressor(ModelA &model, uint8 *src, int comp_size):m_model(model), m_output(WIDTH_IMAGE*HEIGHT_IMAGE),
  m_input(src, CODE_VALUE_BITS, comp_size){
}

int Decompressor::decompress(uint8 *src, uint8 *dst)
{
