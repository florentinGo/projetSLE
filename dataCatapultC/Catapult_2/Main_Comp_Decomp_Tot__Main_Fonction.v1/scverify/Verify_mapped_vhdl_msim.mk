...
# Generated date: Wed Feb 01 17:50:43 CET 2017
#
# ----------------------------------------------------------------------------
# ===================================================
...
ifeq ($(RTLTOOL),)
ifeq ($(GATE_VHDL_DEP),)
GATE_VHDL_DEP = ./mapped.vhdl/mapped.vhdl.vhdlts
endif
ifeq ($(GATE_VLOG_DEP),)
GATE_VLOG_DEP = 
endif
...
VHDL_SRC = ./mapped.vhdl/mapped.vhdl.vhdlts
VLOG_SRC = 
endif
...
RTL_SCRIPT = ./scverify/mapped.psrvhdl
...
$(TARGET)/mapped.vhdl.vhdlts: ./mapped.vhdl
ifeq ($(STAGE),gate)
ifneq ($(GATE_VHDL_DEP),)
...
$(TARGET)/mapped.vhdl.vhdlts: HDL_LIB=work
ifeq ($(STAGE),gate)
ifneq ($(GATE_VHDL_DEP),)
...
$(TARGET)/mapped.vhdl.vhdlts: DUT_E=

# Specify top design unit
$(TARGET)/mapped.vhdl.vhdlts: VHDL_TOP=1
