...
# Generated date: Wed Feb 01 17:50:47 CET 2017
#
# ----------------------------------------------------------------------------
# ===================================================
...
RTL_NETLIST_FNAME           = /tp/xph3sle/xph3sle512/ProjetSLE_bis/dataCatapultC/Catapult_2/Main_Comp_Decomp_Tot__Main_Fonction.v1/rtl.vhdl
endif
...
ifeq ($(RTLTOOL),)
ifeq ($(GATE_VHDL_DEP),)
GATE_VHDL_DEP = ./gate.vhdl/gate.vhdl.vhdlts
endif
ifeq ($(GATE_VLOG_DEP),)
GATE_VLOG_DEP = 
endif
...
VHDL_SRC = ./gate.vhdl/gate.vhdl.vhdlts
VLOG_SRC = 
endif
CXX_SRC  = ../../../Rendu/src/CPP_for_Catapult/comp_decomp_tot/Main_Trans_Ond.cpp/Main_Trans_Ond.cpp.cxxts ../../../Rendu/src/CPP_for_Catapult/comp_decomp_tot/Compressor.cpp/Compressor.cpp.cxxts ../../../Rendu/src/CPP_for_Catapult/comp_decomp_tot/Main_Inv_Wave.cpp/Main_Inv_Wave.cpp.cxxts ../../../Rendu/src/CPP_for_Catapult/comp_decomp_tot/Exchange.cpp/Exchange.cpp.cxxts ../../../Rendu/src/CPP_for_Catapult/comp_decomp_tot/model.cpp/model.cpp.cxxts ../../../Rendu/src/CPP_for_Catapult/comp_decomp_tot/Decompressor.cpp/Decompressor.cpp.cxxts ../../../Rendu/src/CPP_for_Catapult/comp_decomp_tot/Main_Comp_Decomp_Tot.cpp/Main_Comp_Decomp_Tot.cpp.cxxts ./scverify/mc_testbench.cpp/mc_testbench.cpp.cxxts ./scverify/scverify_top.cpp/scverify_top.cpp.cxxts ./top_gate_constraints.cpp/top_gate_constraints.cpp.cxxts
# Specify RTL synthesis scripts (if any)
RTL_SCRIPT = ./scverify/gate.psrvhdl
...
$(TARGET)/gate.vhdl.vhdlts: ./gate.vhdl
ifeq ($(STAGE),gate)
ifneq ($(GATE_VHDL_DEP),)
...
$(TARGET)/gate.vhdl.vhdlts: HDL_LIB=work
ifeq ($(STAGE),gate)
ifneq ($(GATE_VHDL_DEP),)
...
$(TARGET)/gate.vhdl.vhdlts: DUT_E=

# Specify top design unit
$(TARGET)/gate.vhdl.vhdlts: VHDL_TOP=1
