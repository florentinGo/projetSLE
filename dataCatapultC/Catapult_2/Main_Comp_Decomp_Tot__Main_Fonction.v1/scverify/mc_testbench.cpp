...
void testbench::wait_on_input_required()
{
   ...
   while (atleast_one_active_input) {
      ...
      wait(ccs_Src_IN->ok_to_put() | ccs_Comp_IN->ok_to_put() | ccs_Vga_IN->ok_to_put() | ccs_nblevels->ok_to_put());
...
void testbench::capture_IN(Main_Comp_Decomp_Tot *Main_Comp_Decomp_Tot__this,  ac_int<8, false > Src[76800],  ac_int<8, false > Comp[76800],  ac_int<8, false > Vga[76800], ac_int<4, false > nblevels)
{
...
void testbench::capture_OUT(int _TOP__return, Main_Comp_Decomp_Tot *Main_Comp_Decomp_Tot__this,  ac_int<8, false > Src[76800],  ac_int<8, false > Comp[76800],  ac_int<8, false > Vga[76800], ac_int<4, false > nblevels)
{
...
int testbench::exec_Main_Fonction(Main_Comp_Decomp_Tot *Main_Comp_Decomp_Tot__this,  ac_int<8, false > Src[76800],  ac_int<8, false > Comp[76800],  ac_int<8, false > Vga[76800], ac_int<4, false > nblevels)
{
   that->cpp_testbench_active.write(true);
   capture_IN(Main_Comp_Decomp_Tot__this, Src, Comp, Vga, nblevels);
   int _TOP__return = Main_Comp_Decomp_Tot__this->Main_Comp_Decomp_Tot::Main_Fonction(Src, Comp, Vga, nblevels);
   ...
   capture_OUT(_TOP__return, Main_Comp_Decomp_Tot__this, Src, Comp, Vga, nblevels);
   return _TOP__return;
}
// ============================================
