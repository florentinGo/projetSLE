...
// Generated date: Wed Feb 01 17:49:06 CET 2017
//
// ----------------------------------------------------------------------------
...
typedef ccs_design::HDL::Main_Comp_Decomp_Tot_Main_Fonction ccs_DUT_wrapper;
...
public:
   ...
   sc_in< sc_lv<4> > nblevels_rsc_z;
   sc_out< sc_lv<32> > Main_Comp_Decomp_Tot_Main_Fonction_return_rsc_z;
   ...
   sc_out< sc_logic > Main_Comp_Decomp_Tot_Main_Fonction_return_triosy_lz;
   #endif
...
public:
   ccs_DUT_wrapper(const sc_module_name& nm, const char *hdl_name)
      ...
      ,Main_Comp_Decomp_Tot_Main_Fonction_return_rsc_z("Main_Comp_Decomp_Tot_Main_Fonction_return_rsc_z")
      ,Src_triosy_lz("Src_triosy_lz")
      ,Comp_triosy_lz("Comp_triosy_lz")
      ,Vga_triosy_lz("Vga_triosy_lz")
      ,nblevels_triosy_lz("nblevels_triosy_lz")
      ,Main_Comp_Decomp_Tot_Main_Fonction_return_triosy_lz("Main_Comp_Decomp_Tot_Main_Fonction_return_triosy_lz")
      #endif
      {
