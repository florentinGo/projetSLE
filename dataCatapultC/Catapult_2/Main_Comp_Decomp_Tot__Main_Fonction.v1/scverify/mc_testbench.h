...
public:
   ...
   public:
      static void capture_IN(Main_Comp_Decomp_Tot *Main_Comp_Decomp_Tot__this,  ac_int<8, false > Src[76800],  ac_int<8, false > Comp[76800],  ac_int<8, false > Vga[76800], ac_int<4, false > nblevels) ;
   public:
      static void capture_OUT(int _TOP__return, Main_Comp_Decomp_Tot *Main_Comp_Decomp_Tot__this,  ac_int<8, false > Src[76800],  ac_int<8, false > Comp[76800],  ac_int<8, false > Vga[76800], ac_int<4, false > nblevels) ;
   public:
      static int exec_Main_Fonction(Main_Comp_Decomp_Tot *Main_Comp_Decomp_Tot__this,  ac_int<8, false > Src[76800],  ac_int<8, false > Comp[76800],  ac_int<8, false > Vga[76800], ac_int<4, false > nblevels) ;
   protected:
