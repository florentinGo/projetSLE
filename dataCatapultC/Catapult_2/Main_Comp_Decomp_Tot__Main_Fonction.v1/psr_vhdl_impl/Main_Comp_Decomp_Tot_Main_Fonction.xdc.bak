create_clock [get_ports clk] -name clk -period 41.6667 -waveform {0 20.83}
...
# set_property HIERARCHY preserve [get_cells div_mgc_div]
# set_property HIERARCHY preserve [get_cells div_mgc_div_1]
