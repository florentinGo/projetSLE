ifeq "$(CXX_HOME)" ""
CXX_HOME                                      := /softslin/catapult2011a_200_12/Mgc_home
export CXX_HOME
endif
ifeq "$(CXX_TYPE)" ""
CXX_TYPE                                      := gcc
...
ModelSim_SCCOM_OPTS                           := -g -x c++ -L/usr/lib/x86_64-linux-gnu/
...
OSCI_SYSTEMC_INCLUDE                          := /softslin/catapult2011a_200_12/Mgc_home/shared/include
export OSCI_SYSTEMC_INCLUDE
endif
ifeq "$(OSCI_SYSTEMC_LIB)" ""
OSCI_SYSTEMC_LIB                              := /softslin/catapult2011a_200_12/Mgc_home/shared/lib/$(CXX_OS)/$(CXX_TYPE)
...
SCVerify_INCL_DIRS                            := /usr/x86_64-linux-gnu
export SCVerify_INCL_DIRS
endif
ifeq "$(SCVerify_LINK_LIBPATHS)" ""
SCVerify_LINK_LIBPATHS                        := /usr/x86_64-linux-gnu./Catapult/FIR_HARDWARE.v2/usr/lib/usr/lib/x86_64-linux-gnu
...
ifeq "$(LINK_LIBPATHS)" ""
LINK_LIBPATHS                                 := /usr/x86_64-linux-gnu/ ../.././Catapult/FIR_HARDWARE.v2/ /usr/lib /usr/lib/x86_64-linux-gnu
