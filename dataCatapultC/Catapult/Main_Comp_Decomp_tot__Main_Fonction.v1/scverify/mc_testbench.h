...
extern void mc_testbench_Decomp_skip(bool v);
extern void mc_testbench_Vga_skip(bool v);
extern void mc_testbench_nblevels_skip(bool v);
extern void mc_testbench_change_mode_skip(bool v);
extern void mc_testbench_Main_Comp_Decomp_tot__Main_Fonction_return_skip(bool v);

#ifndef SC_USE_STD_STRING
#define SC_USE_STD_STRING
#endif

#include "../../../Rendu/src/CPP_for_Catapult/comp_decomp_tot/Main_Comp_Decomp_tot.h"
#include <systemc.h>
#include <tlm.h>
#include <ac_int.h>
...
public:
   ...
   sc_port< tlm::tlm_fifo_put_if< mgc_sysc_ver_array1D<ac_int<8, false >,76800> > > ccs_Decomp;
   sc_port< tlm::tlm_fifo_put_if< mc_wait_ctrl > > ccs_wait_ctrl_Decomp;
   sc_port< tlm::tlm_fifo_put_if< mgc_sysc_ver_array1D<ac_int<8, false >,76800> > > ccs_Vga_IN;
   sc_port< tlm::tlm_fifo_put_if< mc_wait_ctrl > > ccs_wait_ctrl_Vga_IN;
   ...
   sc_port< tlm::tlm_fifo_put_if< ac_int<4, false > > > ccs_change_mode;
   sc_port< tlm::tlm_fifo_put_if< mc_wait_ctrl > > ccs_wait_ctrl_change_mode;
   sc_port< tlm::tlm_fifo_get_if< int > > ccs_Main_Comp_Decomp_tot__Main_Fonction_return;
   sc_port< tlm::tlm_fifo_put_if< mc_wait_ctrl > > ccs_wait_ctrl_Main_Comp_Decomp_tot__Main_Fonction_return;
   ...
   static bool Decomp_ignore;
   static bool Decomp_skip;
   static int Decomp_array_comp_first;
   static int Decomp_array_comp_last;
   bool _capture_Decomp;
   static int Decomp_wait_cycles;
   static mc_wait_ctrl Decomp_wait_ctrl;
   int Decomp_capture_count;
   int Decomp_iteration_count;
   static bool Vga_ignore;
   static bool Vga_skip;
   static int Vga_array_comp_first;
   static int Vga_array_comp_last;
   bool _capture_Vga_IN;
   static int Vga_IN_wait_cycles;
   static mc_wait_ctrl Vga_IN_wait_ctrl;
   int Vga_IN_capture_count;
   int Vga_IN_iteration_count;
   ...
   static bool change_mode_ignore;
   static bool change_mode_skip;
   static int change_mode_array_comp_first;
   static int change_mode_array_comp_last;
   bool _capture_change_mode;
   static int change_mode_wait_cycles;
   static mc_wait_ctrl change_mode_wait_ctrl;
   int change_mode_capture_count;
   int change_mode_iteration_count;
   static bool Main_Comp_Decomp_tot__Main_Fonction_return_ignore;
   static bool Main_Comp_Decomp_tot__Main_Fonction_return_skip;
   static int Main_Comp_Decomp_tot__Main_Fonction_return_array_comp_first;
   static int Main_Comp_Decomp_tot__Main_Fonction_return_array_comp_last;
   static bool Main_Comp_Decomp_tot__Main_Fonction_return_use_mask;
   static int Main_Comp_Decomp_tot__Main_Fonction_return_output_mask;
   tlm::tlm_fifo< mc_golden_info< int, int > > Main_Comp_Decomp_tot__Main_Fonction_return_golden;
   bool _capture_Main_Comp_Decomp_tot__Main_Fonction_return;
   static int Main_Comp_Decomp_tot__Main_Fonction_return_wait_cycles;
   static mc_wait_ctrl Main_Comp_Decomp_tot__Main_Fonction_return_wait_ctrl;
   int Main_Comp_Decomp_tot__Main_Fonction_return_capture_count;
   int Main_Comp_Decomp_tot__Main_Fonction_return_iteration_count;
   int wait_cnt;
   ...
   mc_comparator< int , int > *Main_Comp_Decomp_tot__Main_Fonction_return_comp;
   ...
   testbench(
      ...
      , ccs_Decomp("ccs_Decomp")
      , ccs_wait_ctrl_Decomp("ccs_wait_ctrl_Decomp")
      , ccs_Vga_IN("ccs_Vga_IN")
      , ccs_wait_ctrl_Vga_IN("ccs_wait_ctrl_Vga_IN")
      , ccs_Vga("ccs_Vga")
      , ccs_wait_ctrl_Vga("ccs_wait_ctrl_Vga")
      , ccs_nblevels("ccs_nblevels")
      , ccs_wait_ctrl_nblevels("ccs_wait_ctrl_nblevels")
      , ccs_change_mode("ccs_change_mode")
      , ccs_wait_ctrl_change_mode("ccs_wait_ctrl_change_mode")
      , ccs_Main_Comp_Decomp_tot__Main_Fonction_return("ccs_Main_Comp_Decomp_tot__Main_Fonction_return")
      , ccs_wait_ctrl_Main_Comp_Decomp_tot__Main_Fonction_return("ccs_wait_ctrl_Main_Comp_Decomp_tot__Main_Fonction_return")
      , cpp_testbench_active("cpp_testbench_active")
      , Src_golden("Src_golden",-1)
      , Comp_golden("Comp_golden",-1)
      , Vga_golden("Vga_golden",-1)
      , Main_Comp_Decomp_tot__Main_Fonction_return_golden("Main_Comp_Decomp_tot__Main_Fonction_return_golden",-1)
   {
      ...
      Main_Comp_Decomp_tot__Main_Fonction_return_comp = new mc_comparator< int , int > (
         "Main_Comp_Decomp_tot__Main_Fonction_return_comp",
         0,
         1
      );
      Main_Comp_Decomp_tot__Main_Fonction_return_comp->data_in(ccs_Main_Comp_Decomp_tot__Main_Fonction_return);
      Main_Comp_Decomp_tot__Main_Fonction_return_comp->data_golden(Main_Comp_Decomp_tot__Main_Fonction_return_golden);
      ...
      _capture_Comp = true;
      _capture_Decomp = true;
      _capture_Vga_IN = true;
      _capture_Vga = true;
      _capture_nblevels = true;
      _capture_change_mode = true;
      _capture_Main_Comp_Decomp_tot__Main_Fonction_return = true;
      wait_cnt = 0;
   }
   ...
   ~testbench()
   {
      ...
      delete Vga_comp;
      Vga_comp = 0;
      delete Main_Comp_Decomp_tot__Main_Fonction_return_comp;
      Main_Comp_Decomp_tot__Main_Fonction_return_comp = 0;
   }
   ...
   public:
      void capture_Decomp( ac_int<8, false > Decomp[76800]) ;
   public:
      void capture_Vga_IN( ac_int<8, false > Vga[76800]) ;
   public:
      void capture_Vga( ac_int<8, false > Vga[76800]) ;
   public:
      void capture_nblevels(ac_int<4, false > nblevels) ;
   public:
      void capture_change_mode(ac_int<4, false > change_mode) ;
   public:
      void capture__TOP__return(int _TOP__return) ;
   protected:
      void wait_on_input_required() ;
   public:
      static void capture_IN(Main_Comp_Decomp_tot *Main_Comp_Decomp_tot__this,  ac_int<8, false > Src[76800],  ac_int<8, false > Comp[76800],  ac_int<8, false > Decomp[76800],  ac_int<8, false > Vga[76800], ac_int<4, false > nblevels, ac_int<4, false > change_mode) ;
   public:
      static void capture_OUT(int _TOP__return, Main_Comp_Decomp_tot *Main_Comp_Decomp_tot__this,  ac_int<8, false > Src[76800],  ac_int<8, false > Comp[76800],  ac_int<8, false > Decomp[76800],  ac_int<8, false > Vga[76800], ac_int<4, false > nblevels, ac_int<4, false > change_mode) ;
   public:
      static int exec_Main_Fonction(Main_Comp_Decomp_tot *Main_Comp_Decomp_tot__this,  ac_int<8, false > Src[76800],  ac_int<8, false > Comp[76800],  ac_int<8, false > Decomp[76800],  ac_int<8, false > Vga[76800], ac_int<4, false > nblevels, ac_int<4, false > change_mode) ;
   protected:
